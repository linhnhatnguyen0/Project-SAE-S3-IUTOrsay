...
Class Utilisateur {
    ...
    public function getTelephoneUtilisateur() {return $this->TelephoneUtilisateur;}
    public function getLoginUtilisateur() {return $this->loginUtilisateur;}
    public function getMdpUtilisateur() {return $this->mdpUtilisateur;}
    public function getBloque() {return $this->bloque;}
    public function getNbEmprunt() {return $this->nbEmprunt;}
    ...
    //setter
    public function setNumUtilisateur($n) {$this->NumUtilisateur = $n;}
    public function setNomUtilisateur($n) {$this->NomUtilisateur = $n;}
    public function setPrenomUtilisateur($p) {$this->PrenomUtilisateur = $p;}
    public function setAdresseUtilisateur($a) {$this->AdresseUtilisateur = $a;}
    public function setTelephoneUtilisateur($t) {$this->TelephoneUtilisateur = $t;}
    public function setLoginUtilisateur($l) {$this->loginUtilisateur = $l;}
    public function setMdpUtilisateur($m) {$this->mdpUtilisateur = $m;}
    public function setBloque($b) {$this->bloque = $b;}
    public function setNbEmprunt($n) {$this->nbEmprunt = $n;}
